 ...
 * @author Diogo
 */
public class TerrenoAgua implements ITerreno {
    private final String SIMBOLO = "~"; // Representa a água no mapa
    ...
    public TerrenoAgua(int x, int y) {
        recursos = new ArrayList<>();
        alvos = new ArrayList<>();
        recursos.add(new RecursoOuro(20)); // Exemplo de inicialização com Minerio
        recursos.add(new RecursoProducao(40)); // Inicializa com Materia Prima
        recursos.add(new RecursoAlimento(40)); // Inicializa com Alimento
        this.cidadaosTrabalhando = 0;
        this.custoMovimento = CUSTO_INACESSIVEL;
        this.x = x;
        this.y = y;
    ...
    *
    * Este método retorna true se o custo de movimento não for considerado 
    * inacessível.
    *
    * @return true se o terreno é acessível, false caso contrário
    */
   @Override
   public boolean eAcessivel() {
       return custoMovimento != CUSTO_INACESSIVEL;
   }

   /**
    * Obtém o custo de movimento para o terreno.
    *
   ...
   public int getCustoMovimento() {
       return custoMovimento; // Indica que o terreno é inacessível
   }
   ...
   /**
    * Obtém o símbolo representativo do terreno.
    *
    * Este método retorna o símbolo do terreno, priorizando o símbolo do 
    * overlay, se existir. Se o terreno estiver sendo trabalhado, um 
    * símbolo destacado é retornado.
    *
    * @return o símbolo do terreno
    */
   @Override
