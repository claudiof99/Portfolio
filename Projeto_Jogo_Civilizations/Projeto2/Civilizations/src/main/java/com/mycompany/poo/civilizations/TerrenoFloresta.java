 ...
 * @author Diogo
 */
public class TerrenoFloresta implements ITerreno {
    private final String SIMBOLO = "F"; // Representa a floresta no mapa
    ...
    public TerrenoFloresta(int x, int y) {
        recursos = new ArrayList<>();
        alvos = new ArrayList<>();
        recursos.add(new RecursoOuro(20)); // Exemplo de inicialização com Minerio
        recursos.add(new RecursoProducao(60)); // Inicializa com Materia Prima
        recursos.add(new RecursoAlimento(80)); // Inicializa com Alimento
        this.cidadaosTrabalhando = 0;
        this.custoMovimento = 2;
        this.x = x;
        this.y = y;
  ...
  /**
   ...
   public int getCustoMovimento() {
       return custoMovimento; // Custo para atravessar a floresta
   }
