 ...
 * @author Diogo
 */
public class TerrenoPlanicie implements ITerreno{
    private final String SIMBOLO = "P"; // Representa a planicie no mapa
    ...
    public TerrenoPlanicie(int x, int y) {
        recursos = new ArrayList<>();
        alvos = new ArrayList<>();
        recursos.add(new RecursoOuro(10)); // Exemplo de inicialização com Minerio
        recursos.add(new RecursoProducao(40)); // Inicializa com Materia Prima
        recursos.add(new RecursoAlimento(20)); // Inicializa com Alimento
   ...
   public int getCustoMovimento() {
       return custoMovimento; // Menor custo para áreas planas
   }
